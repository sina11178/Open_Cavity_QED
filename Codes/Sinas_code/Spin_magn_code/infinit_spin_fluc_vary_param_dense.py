...
- We are exploring parameter space to get a better idea of what is going on w/ spin fluctuations
...
def main_parallelize():
    ...
    #GAMMA = [0]
    J_vals = np.linspace(-1.5, -0.05, 10)
    μ_vals = np.linspace(0.05, 1.2, 10)
    Ωd_vals = np.linspace(0, 4, 10)
    #J= -.05
    #μ = .05 
    #Ωd = 4
    #Ωd = 0
