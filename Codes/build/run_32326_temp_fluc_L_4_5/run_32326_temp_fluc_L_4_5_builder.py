...
partition_info=['cmt',128] # = [partition,ncores]
...
logstr='''run_32326_temp_fluc_L_4_5:
...
#Do the git-ing
cmd='git commit -a -m "Commit before run run_32326_temp_fluc_L_4_5" > /dev/null'
print(cmd)
...
open('run_32326_temp_fluc_L_4_5.log','w').write(logstr)

#Setup the versionmap and qsub files
vmap_file=open('versionmap.dat','w')
vmap_file.write('vnum\tL\n')

task_file=open('run_32326_temp_fluc_L_4_5.task','w')
template_file='run_32326_temp_fluc_L_4_5.template'
...
for L in range(40):
        ...
        task_file.write('bash run_32326_temp_fluc_L_4_5_'+str(vnum)+'.qsub\n')
        fout.write(contents)
        fout.close()
...
contents=open('run_32326_temp_fluc_L_4_5.sbatch.template','r').read()
...
open('run_32326_temp_fluc_L_4_5.sbatch','w').write(contents)
